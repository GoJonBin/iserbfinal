...
let RegistrationPage = class RegistrationPage {
    constructor(datePicker, camera, formBuilder, router, alertController, toastController, modalController) {
                ...
                this.getValidation().then((data) => {
                    ...
                    if (res == "0") {
                        ...
                        axios__WEBPACK_IMPORTED_MODULE_7___default()({
                            ...
                            data: qs__WEBPACK_IMPORTED_MODULE_8___default.a.stringify(data),
    ...
    getValidation() {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function* () {
            try {
                const response = yield axios__WEBPACK_IMPORTED_MODULE_7___default.a.get('http://nathdaaco123-001-site1.ctempurl.com/api/Login/GetCustomer?ContactNo=' + this._phonenumber);
