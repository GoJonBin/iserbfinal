...
class Anchor {
    constructor(hostRef) {
        ...
        this.onClick = (ev) => {
            Object(_chunk_ba834eff_js__WEBPACK_IMPORTED_MODULE_3__["o"])(this.href, ev, this.routerDirection);
        };
    }
    componentDidLoad() {
