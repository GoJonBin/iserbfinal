...
var ProviderUIPageModule = /** @class */ (function () {
    function ProviderUIPageModule() {
    }
...
var ProviderUIPage = /** @class */ (function () {
    function ProviderUIPage(alertController, router, storage) {
    ...
    ProviderUIPage.prototype.showAlert = function () {
        this.information = !this.information;
    };
    ProviderUIPage.prototype.ngOnInit = function () {
    };
    ProviderUIPage.prototype.ionViewDidEnter = function () {
        this.getCredits();
    };
    ProviderUIPage.prototype.getProviderType = function () {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var response, x, error_1;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 3]);
                        return [4 /*yield*/, axios__WEBPACK_IMPORTED_MODULE_3___default.a.get('http://nathdaaco123-001-site1.ctempurl.com/api/Provider/ServiceType?ServiceType=5')];
                    case 1:
                        response = _a.sent();
    ...
    ProviderUIPage.prototype.getCredits = function () {
        var _this = this;
        this.storage.get('session').then(function (val) {
            _this.getInformation(val);
            _this.myphone = val;
            _this.checkIfHasCurrentTransaction(val);
        });
    };
    ProviderUIPage.prototype.getInformation = function (phoneNumber) {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            ...
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 3]);
                        return [4 /*yield*/, axios__WEBPACK_IMPORTED_MODULE_3___default.a.get('http://nathdaaco123-001-site1.ctempurl.com/api/Registration/GetCustomerByPhoneNumber?ContactNo=' + phoneNumber)];
                    case 1:
                        response = _a.sent();
    ...
    ProviderUIPage.prototype.checkIfHasCurrentTransaction = function (phoneNumber) {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            ...
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 3]);
                        return [4 /*yield*/, axios__WEBPACK_IMPORTED_MODULE_3___default.a.get('http://nathdaaco123-001-site1.ctempurl.com/api/Seeker/SeekerProcessCount?ContactNo=' + phoneNumber)];
                    case 1:
                        response = _a.sent();
    ...
    ProviderUIPage.prototype.showSelectedSubject = function (Subject) {
    ...
    ProviderUIPage.prototype.hireJoed = function () {
    };
    ProviderUIPage.prototype.hireButton = function (index) {
        this.presentAlert2(index);
    };
    ProviderUIPage.prototype.presentAlert = function () {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var alert;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                switch (_a.label) {
    ...
    ProviderUIPage.prototype.presentAlert3 = function () {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var alert;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                switch (_a.label) {
    ...
    ProviderUIPage.prototype.presentAlert2 = function (index) {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var alert;
            var _this = this;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                            ...
                            buttons: [
                                ...
                                },
                                {
                                    ...
                                    handler: function () {
                                        ...
                                        console.log(_this.arrayTeacher[index].Id);
                                        _this.someFunction(index).then(function (d) {
                                            _this.responsecode = d;
                                            _this.response = _this.responsecode.data[0].Response;
                                            console.log(_this.response);
                                            if (_this.response == "400") {
                                                _this.presentAlert();
                                            }
                                            else if (_this.transaction != "0") {
                                                _this.presentAlert3();
                                            }
                                            else {
                                                _this.arrayTeacher[0].status == 'Pending';
                                            }
                                        });
                                    }
                                }
    ...
    ProviderUIPage.prototype.someFunction = function (index) {
        var _this = this;
        return new Promise(function (resolve, reject) {
            var data = {
                SeekerName: _this.fullname,
                SeekerPhoneNumber: _this.seekerphonenumber,
                ServiceChoice: "5",
                ProviderID: _this.arrayTeacher[index].Id
            };
    ...
    ProviderUIPage.ctorParameters = function () { return [
...
//# sourceMappingURL=provider-ui-provider-ui-module-es5.js.map