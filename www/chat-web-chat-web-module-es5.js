...
var ChatWebPageModule = /** @class */ (function () {
    function ChatWebPageModule() {
    }
...
var ChatWebPage = /** @class */ (function () {
    function ChatWebPage(af, fs, navCtrl) {
        this.af = af;
        this.fs = fs;
    ...
    ChatWebPage.prototype.send = function () {
        if (this.text != '') {
    ...
    ChatWebPage.prototype.backBtn = function () {
        this.navCtrl.back();
    };
    ChatWebPage.ctorParameters = function () { return [
...
//# sourceMappingURL=chat-web-chat-web-module-es5.js.map