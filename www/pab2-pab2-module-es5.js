...
var Pab2PageModule = /** @class */ (function () {
    function Pab2PageModule() {
    }
...
var Pab2Page = /** @class */ (function () {
    function Pab2Page(storage, modalController) {
        this.storage = storage;
        this.modalController = modalController;
        this.dynamicColor = 'blue';
    }
    Pab2Page.prototype.ionViewDidEnter = function () {
        this.getCredits();
    };
    Pab2Page.prototype.getCredits = function () {
        var _this = this;
        this.storage.get('session').then(function (val) {
            _this.getValidation(val);
        });
    };
    Pab2Page.prototype.presentModal = function () {
    ...
    Pab2Page.prototype.getValidation = function (phoneNumber) {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            ...
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 3]);
                        return [4 /*yield*/, axios__WEBPACK_IMPORTED_MODULE_3___default.a.get('http://nathdaaco123-001-site1.ctempurl.com/api/Provider/Credits?ContactNo=' + phoneNumber)];
                    case 1:
                        response = _a.sent();
    ...
    Pab2Page.ctorParameters = function () { return [
...
//# sourceMappingURL=pab2-pab2-module-es5.js.map