...
var SettingsProviderPageModule = /** @class */ (function () {
    function SettingsProviderPageModule() {
    }
    ...
    return SettingsProviderPageModule;
}());
...
var SettingsProviderPage = /** @class */ (function () {
    function SettingsProviderPage(router, storage) {
        this.router = router;
        this.storage = storage;
    }
    SettingsProviderPage.prototype.ngOnInit = function () {
        this.currentIDPhoto = '/assets/img/idPhoto.png';
        this.currentIDHandheld = '/assets/img/idPhoto.png';
    };
    SettingsProviderPage.prototype.back = function () {
        this.router.navigateByUrl('/pabs/pabs/pab3');
    };
    SettingsProviderPage.prototype.ionViewDidEnter = function () {
        this.getCredits();
    };
    SettingsProviderPage.prototype.getCredits = function () {
        var _this = this;
        this.storage.get('session').then(function (val) {
            _this.getInformation(val);
        });
    };
    SettingsProviderPage.prototype.getInformation = function (phoneNumber) {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            ...
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 3]);
                        return [4 /*yield*/, axios__WEBPACK_IMPORTED_MODULE_4___default.a.get('http://nathdaaco123-001-site1.ctempurl.com/api/Registration/GetCustomerByPhoneNumber?ContactNo=' + phoneNumber)];
                    case 1:
                        response = _a.sent();
    ...
    SettingsProviderPage.prototype.onUpdate = function () {
        var data = {
            ID: this._id,
    ...
    SettingsProviderPage.ctorParameters = function () { return [
...
//# sourceMappingURL=settings-provider-settings-provider-module-es5.js.map