...
let ChatHomePageModule = class ChatHomePageModule {
};
...
let ChatHomePage = class ChatHomePage {
    constructor(nav, router, fs, af) {
        this.nav = nav;
        this.router = router;
        this.fs = fs;
        this.af = af;
...
//# sourceMappingURL=chat-home-chat-home-module-es2015.js.map