...
var Pab1PageModule = /** @class */ (function () {
    function Pab1PageModule() {
    }
...
var Pab1Page = /** @class */ (function () {
    function Pab1Page(navCtrl, loadingController, localNotifications, storage, route, router, modalController) {
    ...
    Pab1Page.prototype.ngOnInit = function () {
        var _this = this;
    ...
    Pab1Page.prototype.ionViewDidEnter = function () {
        var _this = this;
        this.loadmap();
        this.storage.get('session').then(function (val) {
            _this.getInformation(val);
    ...
    Pab1Page.prototype.jobOfferNotif = function () {
    ...
    Pab1Page.prototype.afterGettingDestination = function () {
    ...
    Pab1Page.prototype.presentLoadingWithOptions = function () {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var loading;
            var _this = this;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
    ...
    Pab1Page.prototype.push = function () {
        this.navCtrl.back();
    };
    Pab1Page.prototype.getProviderLocation = function () {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
    ...
    Pab1Page.prototype.cancel = function () {
        mymap.removeLayer(mark1);
    };
    Pab1Page.prototype.findNearby = function () {
    ...
    Pab1Page.prototype.getInformation = function (id) {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var response, x, error_2;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 3]);
                        return [4 /*yield*/, axios__WEBPACK_IMPORTED_MODULE_8___default.a.get('http://nathdaaco123-001-site1.ctempurl.com/api/Provider/SeekerCounts?ContactNo=' + id)];
                    case 1:
                        response = _a.sent();
    ...
    Pab1Page.prototype.loadmap = function () {
    ...
    Pab1Page.prototype.presentModal = function () {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var modal;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                switch (_a.label) {
    ...
    Pab1Page.prototype.getValidation = function (phoneNumber) {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            ...
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 3]);
                        return [4 /*yield*/, axios__WEBPACK_IMPORTED_MODULE_8___default.a.get('http://nathdaaco123-001-site1.ctempurl.com/api/Provider/Credits?ContactNo=' + phoneNumber)];
                    case 1:
                        response = _a.sent();
    ...
    Pab1Page.ctorParameters = function () { return [
...
//# sourceMappingURL=pab1-pab1-module-es5.js.map